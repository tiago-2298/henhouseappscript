...
const PRODUCTS_CAT = {
  plats_principaux: [
    ...
    "Wings Epicé",
    "Effiloché de Mouton",
    "Burger Gourmet au Foie Gras",
  ],
  desserts: [
    "Mousse au café",
    "Tiramisu Fraise",
    "Carpaccio Fruit Exotique",
  ...
  menus: [
    "LA SIGNATURE VÉGÉTALE",
    "LE PRESTIGE DE LA MER",
    "LE RED WINGS",
    "LE SOLEIL D'OR",
    'LE SIGNATURE "75"',
  ...
  alcools: [
    ...
    "Verre de Vodka",
    "Verre de Rhum",
    "Verre de Tequila Citron",
    "Verre de Gin",
    "Verre de Gin Fizz Citron",
    "Bouteille de Cidre",
...
const PRICE_LIST = {
  // Plats
  "Lasagne aux légumes": 50,
  "Saumon grillé": 35,
  "Crousti-Douce": 65,
  "Paella Méditerranéenne": 65,
  "Steak 'Potatoes": 40,
  Ribs: 45,
  "Filet Mignon": 50,
  "Poulet Rôti": 60,
  "Wings Epicé": 65,
  "Effiloché de Mouton": 65,
  "Burger Gourmet au Foie Gras": 75,

  // Desserts
  "Mousse au café": 25,
  "Tiramisu Fraise": 30,
  "Carpaccio Fruit Exotique": 30,
  "Profiteroles au chocolat": 35,
  ...
  // Menus
  "LA SIGNATURE VÉGÉTALE": 80,
  "LE PRESTIGE DE LA MER": 90,
  "LE RED WINGS": 110,
  "LE SOLEIL D'OR": 100,
  'LE SIGNATURE "75"': 100,
  "L'HÉRITAGE DU BERGER": 120,
  "LA CROISIÈRE GOURMANDE": 120,

  // Alcools
  "Verre de Cidre en Pression": 10,
  "Verre de Champagne": 15,
  "Verre de rosé": 20,
  "Verre de Champomax": 25,
  "Verre de Bellini": 25,
  "Verre Vin Rouge": 25,
  "Verre Vin Blanc": 30,
  "Verre de Cognac": 30,
  ...
  "Verre de Vodka": 45,
  "Verre de Rhum": 45,
  "Verre de Tequila Citron": 50,
  "Verre de Gin": 65,
  "Verre de Gin Fizz Citron": 70,
  "Bouteille de Cidre": 50,
...
async function sendDiscordWebhook(url, payload, fileBase64 = null) {
  ...
  try {
    if (fileBase64) {
      ...
      const buffer = Buffer.from(base64Data, "base64"); // ✅ Node-safe
...
async function updateEmployeeStats(employeeName, amount, type) {
  try {
    ...
    const rowIndex = rows.findIndex(
      (r) => r[0] && r[0].trim().toLowerCase() === employeeName.trim().toLowerCase()
    );
