...
const PARTNERS = {
  companies: {
    ...
    'Esthétique Paleto': {
      ...
      beneficiaries: [ 'Charlie Senna Mendoza','Luis Blanchette','Rose Brown','Bocceli Hennessy','Isalia Wiston','Armando Sainz','Kario Freeman','Kled Antonio','Noa Park','William Senna','Amael Bouné','Mathéo Erea','Colt Carson','Lucas Binottie','Lyam Foster','Marvin B Jackson','Selyan Sahali',],
      menus: [
